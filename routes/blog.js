...
router.delete('/user/blog/:slug', requireSignin, authMiddleware, remove); //canUpdateDeleteBlog,
router.put('/user/blog/:slug', requireSignin, authMiddleware, update); //canUpdateDeleteBlog,
